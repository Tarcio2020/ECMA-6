...
var promiseComParemetros = function promiseComParemetros(login, senha) {
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      resolve("Logado com o usu\xE1rio ".concat((login, senha)));
    }, 3000);
  });
};
console.log('inicio');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promiseComParemetros('Tarcio@gmail', 142552155).then(function (resultado) {
